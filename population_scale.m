...
app.Pop_Data.DATA = app.DATA(I_pop,:)./POP(I_pop)*1e4;
app.Pop_Data.DATA_Deaths = app.DATA_Deaths(I_pop,:)./POP(I_pop)*1e4;
app.Pop_Data.DATA_Recov = app.DATA_Recov(I_pop,:)./POP(I_pop)*1e4;
